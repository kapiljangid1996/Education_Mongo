...
<section class="probootstrap-section probootstrap-section-colored probootstrap-bg probootstrap-custom-heading probootstrap-tab-section" style="background-image: url({{ URL::asset('frontDesign/img/1.jpg') }})">
	...
	<div class="probootstrap-tab-style-1">
		<ul class="nav nav-tabs probootstrap-center probootstrap-tabs no-border">
			<li class="active"><a data-toggle="tab" href="#featured-courses">All Courses</a></li>
			@foreach ($categories as $category)
				<li><a data-toggle="tab" href="#upcoming-events">{{ $category->cat_name }}</a></li>
			@endforeach
		</ul>
	</div>
</section>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="tab-content">
					<div id="featured-courses" class="tab-pane fade in active">
						<div class="row">
							<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="owl-carousel" id="owl2">
									@foreach($courses as $course)
									@if($course->category_id == $category->_id)
									<div class="item">
										<a href="#" class="probootstrap-featured-news-box"><figure class="probootstrap-media"><img src="/Uploads/Course/{{$course->course_image}}" class="img-responsive"></figure>
											<div class="probootstrap-text">
												<h3>{{$course->course_name}}</h3>
