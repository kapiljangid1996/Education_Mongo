...
<nav aria-label="breadcrumb" role="navigation">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item"><a href="{{url('/admin/exam/syllabus/'.$id)}}">Syllabus</a></li>
...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<hr>
			<div class="card-body">
				<form action="{{url('admin/exam/syllabus/add_syllabus')}}" method="POST">
					@csrf
					<div class="row">
						<label class="col-sm-2 col-form-label">Content</label>
						<div class="col-sm-10">
							<div class="form-group">
								<input type="text" class="form-control" name="syllabus_name" id="name" placeholder="Here.." value="{{ old('syllabus_name') }}" required>
					...
					<div class="row">
						...
						<div class="col-sm-10">
							<div class="form-group">
								<input type="text" class="form-control" name="syllabus_slug" id="slug" placeholder="Here.." value="{{ old('syllabus_slug') }}" required>
					...
					<div class="row">
						...
						<div class="col-sm-10">
							<div class="form-group">
								<textarea class="form-control" name="syllabus_description" required>{{ old('syllabus_description') }}</textarea>
								{!! $errors->first('syllabus_description', '<small class="text-danger">:message</small>') !!}
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-sm-10">
							<div class="form-group">
								<textarea class="form-control" name="syllabus_short_description" rows="3" placeholder="Here.." required>{{ old('syllabus_short_description') }}</textarea>
