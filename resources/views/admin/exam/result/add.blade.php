...
<nav aria-label="breadcrumb" role="navigation">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item"><a href="{{url('/admin/exam/result/'.$id)}}">Result</a></li>
...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<hr>
			<div class="card-body">
				<form action="{{url('admin/exam/result/add_result')}}" method="POST">
					@csrf
					<div class="row">
						<label class="col-sm-2 col-form-label">Content</label>
						<div class="col-sm-10">
							<div class="form-group">
								<input type="text" class="form-control" name="result_name" id="name" placeholder="Here.." value="{{ old('result_name') }}" required>
								{!! $errors->first('result_name', '<small class="text-danger">:message</small>') !!}
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-sm-10">
							<div class="form-group">
								<input type="text" class="form-control" name="result_slug" id="slug" placeholder="Here.." value="{{ old('result_slug') }}" required>
								{!! $errors->first('result_slug', '<small class="text-danger">:message</small>') !!}
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-sm-10">
							<div class="form-group">
								<textarea class="form-control" name="result_description" required>{{ old('result_description') }}</textarea>
								{!! $errors->first('result_description', '<small class="text-danger">:message</small>') !!}
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-sm-10">
							<div class="form-group">
								<textarea class="form-control" name="result_short_description" rows="3" placeholder="Here.." required>{{ old('result_short_description') }}</textarea>
								{!! $errors->first('result_short_description', '<small class="text-danger">:message</small>') !!}
							</div>
						</div>
					</div>
					<div class="row">
