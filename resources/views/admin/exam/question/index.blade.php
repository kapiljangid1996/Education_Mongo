										...
										<tr>
											...
											<td class="td-actions text-left">
												<div class="input-group"> 
													<a href="/admin/exam/question/edit_question/{{ $question->id }}" class="btn btn-success btn-link">
	                              						<i class="material-icons">edit</i>
	                            					</a>
	                            					<button type="button" class="btn btn-danger btn-link" onclick="return confirm('Are you sure you want to delete')">
	                              						<a href="/admin/exam/question/delete_question/{{ $question->id }}">
