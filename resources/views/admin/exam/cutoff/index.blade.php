	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header card-header-primary card-header-icon">
				...
				<h4 class="card-title">Cut Off</h4>
			</div>
			<div class="card-body">				
					...
					<div class="dataTables_wrapper dt-bootstrap4">
						<div class="row">
							<div class="col-sm-12 col-md-6">
								<div class="toolbar">
									<a href="{{url('admin/exam/cutoff/add_cutoff/'.$id)}}" class="btn btn-primary btn-round">Add</a>
								</div>
							</div>
							<div class="col-sm-12 col-md-6">
								...
								<table id="file_export" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
									...
									<tbody id="myTable">
										...
										<tr>
											...
											<td>{{ $cutoff->cutoff_name }}</td>
											<td>{{ $cutoff->cutoff_slug }}</td>
											<td>
												@if($cutoff->status == 1)
			                                      	Active
			                                  	@else
											...
											<td class="td-actions text-left">
												<div class="input-group"> 
													<a href="/admin/exam/cutoff/edit_cutoff/{{ $cutoff->id }}" class="btn btn-success btn-link">
	                              						<i class="material-icons">edit</i>
	                            					</a>
	                            					<button type="button" class="btn btn-danger btn-link" onclick="return confirm('Are you sure you want to delete')">
	                              						<a href="/admin/exam/cutoff/delete_cutoff/{{ $cutoff->id }}">
