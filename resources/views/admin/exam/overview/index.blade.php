					...
					<div class="dataTables_wrapper dt-bootstrap4">
						<div class="row">
							<div class="col-sm-12 col-md-6">
								<div class="toolbar">
									<a href="{{url('admin/exam/overview/add_overview/'.$id)}}" class="btn btn-primary btn-round">Add</a>
								</div>
							</div>
							<div class="col-sm-12 col-md-6">
								...
								<table id="file_export" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
									...
									<tbody id="myTable">
										...
										<tr>
											...
											<td>{{ $overview->overview_name }}</td>
											<td>{{ $overview->overview_slug }}</td>
											<td>
											...
											<td class="td-actions text-left">
												<div class="input-group"> 
													<a href="/admin/exam/overview/edit_overview/{{ $overview->id }}" class="btn btn-success btn-link">
	                              						<i class="material-icons">edit</i>
	                            					</a>
	                            					<button type="button" class="btn btn-danger btn-link" onclick="return confirm('Are you sure you want to delete')">
	                              						<a href="/admin/exam/overview/delete_overview/{{ $overview->id }}">
